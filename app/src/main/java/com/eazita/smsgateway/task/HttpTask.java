...
import com.eazita.smsgateway.JsonUtils;
import com.eazita.smsgateway.Base64Coder;
import com.eazita.smsgateway.App;
import com.eazita.smsgateway.XmlUtils;
...
public class HttpTask extends BaseHttpTask {
    ...
    protected HttpResponse doInBackground(String... ignored) {        
        ...
        params.add(new BasicNameValuePair("phone_number1", app.getPhoneNumbersec()));
